...
const sectionEntries: PreferenceSearchEntry[] = [
  ...
  },
  {
    id: 'commandcode-cli',
    pane: 'commandcode',
    paneTitle: 'Command Code',
    type: 'section',
    title: 'Command Code CLI',
    sectionTitle: 'Command Code',
    keywords: ['command code', 'commandcode', 'cmd cli', 'cmd login'],
    anchorId: 'pref-commandcode-section-cli',
    fallbackAnchorId: 'pref-pane-commandcode',
  },
  {
    id: 'commandcode-settings',
    pane: 'commandcode',
    paneTitle: 'Command Code',
    type: 'section',
    title: 'Command Code Settings',
    sectionTitle: 'Command Code',
    keywords: ['command code model', 'cmd model'],
